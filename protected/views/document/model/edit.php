		...
		<div id="setheight" class="settype_main settype_new_main">
			...
			<div class="settype_table">		    
                                    ...
                                    <div class="settype_newbox">                                        
                                        <ul class="clearfix">
                                                ...
                                                <li style="height:auto;">
                                                    <label class="fl"><?php echo Bll_Document::$doc_title[$tid]?></label>
				...
				<div class="settype_button">
                                    ...
                                    <a href="<?php echo $this->createUrl('/document/model/index')?>">返回</a>
                                </div>		
			</div>
                    </form>
		</div>
...
<script type="text/javascript">
    var ajaxurl = '<?php echo $this->createUrl('/document/model/ajax');?>';
...
$('#fsave').click(function(){
    ...
    $('#personinfo label').each(function(){
        ids.push([ $(this).attr('id'),$(this).html() ]);
    });
    
    $.ajax({
        type : "post",
        url : ajaxurl,
        data:{type:"add_data",tid:<?php echo $tid;?>,ids:ids},
        dataType:"json",
        async:false,
        success:function(data){
            if (data.code == "success"){
                location.href = '<?php echo Yii::app()->createUrl('/document/model/index')?>';
            }else{
                alert(data.mes);
            }
        }
